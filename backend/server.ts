...
// ✅ FIXED: Express 5 route for preflight OPTIONS request
app.options('/{*}', cors()); // Express 5 requires named wildcard not regex
...
// ✅ Upload route: receives video, runs FFmpeg HLS + thumbnail
